...
cvtFreeSurfer = ('T1_weighted_FreeSurfer_BRAVO_IR_ARC2_1mm_Cor', 'T1_weighted_FreeSurfer_BRAVO_IR-SPGR_ASSET2_1mm_Cor')
...
def convertMrSession(mrsession):
    ...
    for series_desc in mult_scan_dict.keys():
        for series_id in mult_scan_dict[series_desc]:
            ...
            if series_desc.startswith(cvtFreeSurfer) and hq:
                genrDcm2Mgz(dcm, oDir, series_desc, series_id)
