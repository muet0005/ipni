...
class knicrDTIprep():
    ...
    def fit(self, **kwargs):
        ...
        if not os.path.exists(fa):
            ...
            dtifit = fsl.DTIFit(base_name=obn, bvals=self.bvals, bvecs=self.bvecs, dwi=self.data, mask=self.nodif_brain_mask, sse=True, op_str=opStr, terminal_output='stream', ignore_exception=True)
            dtifit.run()
            logFile = obn + '.log'
