...
xnatFile = open('/Users/rmuetzel/Desktop/GenR_XNAT_dataDump_08jan2020.csv', 'r')
oFile = open('/Volumes/data/UITWISSEL/ryan/forRonald/GenR_XNAT_dataDump_08jan2020_forRonald_Clean.csv', 'w')
